...
if(preg_match('/increaseWalletWithCartToCart/',$data)) {
    ...
    sendMessage('👑',$cancelKey);
    $btnCopyCard = ['inline_keyboard'=>[[['text'=>'کپی کردن شماره کارت','copy_text'=>['text'=>$paymentKeys['bankAccount']]]]]];
    sendMessage(str_replace(["ACCOUNT-NUMBER", "HOLDER-NAME"],[$paymentKeys['bankAccount'],$paymentKeys['holderName']], $mainValues['increase_wallet_cart_to_cart']),$btnCopyCard, "HTML");
    exit;
}
...
if(preg_match('/payCustomWithCartToCart(.*)/',$data, $match)) {
    ...
    sendMessage('👑',$cancelKey);
    $btnCopyCard = ['inline_keyboard'=>[[['text'=>'کپی کردن شماره کارت','copy_text'=>['text'=>$paymentKeys['bankAccount']]]]]];
    sendMessage(str_replace(["ACCOUNT-NUMBER", "HOLDER-NAME"],[$paymentKeys['bankAccount'],$paymentKeys['holderName']], $mainValues['buy_account_cart_to_cart']),$btnCopyCard, "HTML");
    exit;
}
...
if(preg_match('/payRenewWithCartToCart(.*)/',$data,$match)) {
    ...
    sendMessage('👑',$cancelKey);
    $btnCopyCard = ['inline_keyboard'=>[[['text'=>'کپی کردن شماره کارت','copy_text'=>['text'=>$paymentKeys['bankAccount']]]]]];
    sendMessage(str_replace(['ACCOUNT-NUMBER', 'HOLDER-NAME'],[$paymentKeys['bankAccount'], $paymentKeys['holderName']], $mainValues['renew_ccount_cart_to_cart']),$btnCopyCard,"html");
    exit;
}
