...
if($list->num_rows > 0){
    ...
    if($offset == '0'){
        if($type == "forwardall")   $msg = "📤 عملیات هدایت همگانی شروع شد. لطفاً تا پایان عملیات صبور باشید...";
        else  $msg = "✉️ عملیات ارسال پیام همگانی شروع شد. لطفاً تا اتمام ارسال صبور باشید...";
    ...
    if($usersList->num_rows > 0) {
        ...
        else $msg = "✉️ عملیات ارسال پیام همگانی با موفقیت انجام شد";
        
        bot('sendMessage',[
            'chat_id'=>$admin,
            'text' => $msg . "\n👥 پیام شما با موفقیت به " . $offset . " نفر ارسال شد ✅"
            ]);
